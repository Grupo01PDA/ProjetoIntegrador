...
function UsuariosFeed(){
    return(
        <nav className="posts_etc">
            ...
            <button id="salvos" className="salvos">
                <svg className="salvos-svg" width="28" height="36" viewBox="0 0 28 36" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <line x1="1.5" y1="0.500488" x2="26.9438" y2="0.500488" stroke="#0F0F0F"
                        strokeLinecap="round" />
                    <path d="M1.1875 34.9996L1.1875 0.999976" stroke="#0F0F0F" strokeLinecap="round" />
                    <path d="M1.1875 34.9994L14.2231 21.9638" stroke="#0F0F0F" strokeLinecap="round" />
                    <path d="M27.2563 35L27.2563 1.00034" stroke="#0F0F0F" strokeLinecap="round" />
                    <path d="M27.2563 34.9996L14.2208 21.9641" stroke="#0F0F0F" strokeLinecap="round" />
                </svg>
                <span className="userInputs">Salvos</span>
            </button>
            <button id="provas" className="gabaritos">
                <svg className="provas-svg" width="23" height="34" viewBox="0 0 23 34" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
